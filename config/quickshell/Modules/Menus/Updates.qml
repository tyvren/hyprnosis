    ...
    ColumnLayout {
      ...
      Item { implicitWidth: 350; implicitHeight: 60
        ...
        Rectangle {
          ...
          Text { anchors.centerIn: parent; color: theme.colAccent; font.family: theme.fontFamily; font.pixelSize: 22; text: "Update System" }
      ...
      Item { implicitWidth: 350; implicitHeight: 60
        ...
        Rectangle {
          ...
          Text { anchors.verticalCenter: parent.verticalCenter; anchors.left: parent.left; anchors.leftMargin: 15; color: theme.colAccent; font.family: theme.fontFamily; font.pixelSize: 28; text: "" }
          Text { anchors.centerIn: parent; color: theme.colAccent; font.family: theme.fontFamily; font.pixelSize: 22; text: "Update AUR" }
      ...
      Item { implicitWidth: 350; implicitHeight: 60
        ...
        Rectangle {
          ...
          Text { anchors.verticalCenter: parent.verticalCenter; anchors.left: parent.left; anchors.leftMargin: 15; color: theme.colAccent; font.family: theme.fontFamily; font.pixelSize: 28; text: "" }
          Text { anchors.centerIn: parent; color: theme.colAccent; font.family: theme.fontFamily; font.pixelSize: 22; text: "Update hyprnosis" }
